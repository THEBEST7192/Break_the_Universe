...
class SolarSystem(Window):
    def __init__(self):
        ...
        self.planets = [
            ...
            # Nucelear Reactor (4 sections of radial lines)
            # Section 1 (0 rad)
            (100, 100, 1.0, 5, "#FFFFFF", 0),
            (120, 120, 1.0, 5, "#FFFFFF", 0),
            (140, 140, 1.0, 5, "#FFFFFF", 0),
            (160, 160, 1.0, 5, "#FFFFFF", 0),
            (180, 180, 1.0, 5, "#FFFFFF", 0),
            (200, 200, 1.0, 5, "#FFFFFF", 0),
            # Section 2 (pi/2 rad) 
            (100, 100, 1.0, 5, "#FFFFFF", math.pi/2),
            (120, 120, 1.0, 5, "#FFFFFF", math.pi/2),
            (140, 140, 1.0, 5, "#FFFFFF", math.pi/2),
            (160, 160, 1.0, 5, "#FFFFFF", math.pi/2),
            (180, 180, 1.0, 5, "#FFFFFF", math.pi/2),
            (200, 200, 1.0, 5, "#FFFFFF", math.pi/2),
            # Section 3 (pi rad)
            (100, 100, 1.0, 5, "#FFFFFF", math.pi),
            (120, 120, 1.0, 5, "#FFFFFF", math.pi),
            (140, 140, 1.0, 5, "#FFFFFF", math.pi),
            (160, 160, 1.0, 5, "#FFFFFF", math.pi),
            (180, 180, 1.0, 5, "#FFFFFF", math.pi),
            (200, 200, 1.0, 5, "#FFFFFF", math.pi),
            # Section 4 (3pi/2 rad)
            (100, 100, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            (120, 120, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            (140, 140, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            (160, 160, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            (180, 180, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            (200, 200, 1.0, 5, "#FFFFFF", 3*math.pi/2),
            # Other Reactor part
